...
PcadischargeWidgetView = (function(superClass) {
  ...
  PcadischargeWidgetView.prototype.data_update = function(data) {
    ...
    for (idx = k = 0, len1 = ref1.length; k < len1; idx = ++k) {
      ...
      alarm_heat_timer = this.vals["" + pre + this.tags.alarm_heat_timer];
      alarm_cool_timer = this.vals["" + pre + this.tags.alarm_cool_timer];
...
},{"./iops_widget_view":61}],73:[function(require,module,exports){
