...
window.App = (function() {
  ...
  App.on("before:start", function(options) {
    ...
    App.vent.on("app:dash_lock", function() {
      var lock;
      lock = App.session.get("settings").dash_lock;
      $("a#lock_dash i.fa").toggleClass("fa-toggle-off", !lock).toggleClass("fa-toggle-on", lock);
      if ((App.currentView != null) && (App.currentView.grid != null)) {
        if (lock) {
          App.currentView.grid.disable();
          return $("a#lock_dash span.lock_label").html("LOCKED");
        } else {
          App.currentView.grid.enable();
          return $("a#lock_dash span.lock_label").html("UNLOCKED");
        }
      }
    });
...
AppConfig = (function(superClass) {
  ...
  AppConfig.report_server = 'http://reporting.iopspro.com/';
...
DashboardSideView = (function(superClass) {
  ...
  DashboardSideView.prototype.toggle_dash = function(e) {
    var lock, s;
...
WidgetLayout = (function(superClass) {
  ...
  WidgetLayout.prototype.onShow = function() {
    ...
    return App.vent.trigger("app:dash_lock");
  };
...
PermissionsLayout = (function(superClass) {
  ...
  PermissionsLayout.prototype.show_tab = function(tab) {
    ...
    this.$(this.regions.permissions_region).hide();
    this.$(this.regions.roles_region).hide();
    this.$(this.regions.users_region).hide();
    switch (tab) {
      case 'permissions':
        this.pv = new PermissionsTopView;
        this.permissions_region.show(this.pv);
        return this.$(this.regions.permissions_region).show();
      case 'roles':
        this.rv = new RolesTopView;
        this.roles_region.show(this.rv);
        return this.$(this.regions.roles_region).show();
      case 'users':
        this.uv = new UsersLayout();
        this.users_region.show(this.uv);
        return this.$(this.regions.users_region).show();
    }
  };
...
UsersLayout = (function(superClass) {
  ...
  UsersLayout.prototype.rebuild_view = function() {
    ...
    return this.tempusers.fetch({
      success: (function(_this) {
        return function() {
          var global_admin, i, len, ref, site_admin, u;
          _this.$('.loading').hide();
          _this.$('.preamble').show();
...
AirportoverviewWidgetView = (function(superClass) {
        ...
        for (z in term) {
          ...
          for (g in zone) {
            gate = {
              ...
              Tag_gate_critical: this.cloud_prefix + "Airport." + this.site_code + ".Term" + t + ".Zone" + z + ".Gate" + g + ".Alarm._HasCritialAlarms",
              Tag_gate_perfect_dock: this.cloud_prefix + "Airport." + this.site_code + ".Term" + t + ".Zone" + z + ".Gate" + g + ".PBB.PerfectDock",
              Tag_gate_out_of_service: this.cloud_prefix + "Airport." + this.site_code + ".Term" + t + ".Zone" + z + ".Gate" + g + ".PBB.OutOfService"
            };
  ...
  AirportoverviewWidgetView.prototype.data_update = function(data) {
    var alarm, critical, docked, g, goos, i, len, outOfService, perfectDock, qa, qc, qd, qoos, qpd, ref;
    ref = this.gateData;
    for (i = 0, len = ref.length; i < len; i++) {
      g = ref[i];
      outOfService = null;
      ...
      qoos = this.opc.tags["" + g.Tag_gate_out_of_service].props.Value.quality;
      if ((qoos != null) && goos) {
