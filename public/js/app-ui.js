...
window.JST["widgets/pbb_pca_gpu_status_widget"] = function(__obj) {
  var _safe = function(value) {
    if (typeof value === 'undefined' && value == null)
      value = '';
    var result = new String(value);
...
window.JST["widgets/pbb_system_status_widget"] = function(__obj) {
  var _safe = function(value) {
    if (typeof value === 'undefined' && value == null)
      value = '';
    var result = new String(value);
...
},{"./app_controller":2,"./common/adminlte_lib":3,"./common/appconfig":4,"./common/baseline_app":5,"./common/extensions":6,"./common/tagconfig":7,"./common/uiutils":8,"./models/account_collection":12,"./models/claim_collection":14,"./models/role_collection":18,"./models/session":19,"./models/site_collection":21,"./models/user_collection":23,"./opcmanager":26,"./router":27,"./views/app_layout":28,"./views/widgets/advanced_alarm_widget_view":56,"./views/widgets/airport_overview_widget_view":57,"./views/widgets/alarm_widget_view":58,"./views/widgets/asset_widget_view":59,"./views/widgets/basekpi_site_widget_view":60,"./views/widgets/config_widget_view":61,"./views/widgets/gpu_summary_widget_view":62,"./views/widgets/gpu_widget_view":63,"./views/widgets/kpi_widget_view":65,"./views/widgets/pbb_detail_widget_view":66,"./views/widgets/pbb_level_detail_widget_view":67,"./views/widgets/pbb_pca_gpu_basic_widget_view":68,"./views/widgets/pbb_pca_gpu_status_widget_view":69,"./views/widgets/pbb_system_status_widget_view":70,"./views/widgets/pbb_widget_view":71,"./views/widgets/pca_discharge_widget_view":72,"./views/widgets/pca_summary_widget_view":73,"./views/widgets/pca_widget_view":74,"./views/widgets/report_widget_view":75,"./views/widgets/url_widget_view":76,"./views/widgets/video_widget_view":77,"./views/widgets/weather_widget_view":78}],2:[function(require,module,exports){
    ...
    PHX: {
      pca_widget: {
        ...
        update_tags: {
          ...
          pca_bridge_damper: {
            Tag: 'PCA.BRIDGE_DAMPER_POSITION',
            Label: 'Aircraft Cool is running',
            DataType: 'Boolean',
            Parameters: {
              Parm001: 'On',
              Parm002: 'Off',
        ...
        add_tags: {
          ...
          pca_blowercurrent: {
            Tag: 'PCA.BLOWERCURRENT',
            Label: 'Blower Current',
            DataType: 'Float',
            Parameters: {
              Parm001: false,
              Parm002: null,
...
var BaseKpiSiteWidgetView, IOPSWidgetView, Marionette,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
BaseKpiSiteWidgetView = (function(superClass) {
  extend(BaseKpiSiteWidgetView, superClass);

  function BaseKpiSiteWidgetView() {
    this.set_model = bind(this.set_model, this);
    return BaseKpiSiteWidgetView.__super__.constructor.apply(this, arguments);
  }

  BaseKpiSiteWidgetView.prototype.template = "widgets/basekpi_site_widget";

  BaseKpiSiteWidgetView.prototype.classID = 'basekpi_site_widget';

  BaseKpiSiteWidgetView.prototype.className = 'widget-outer box box-primary basekpi_site_widget';

  BaseKpiSiteWidgetView.prototype.ui = {
    site: 'select#site',
    wtitle: 'h3.box-title',
    display: '.display',
    content: '.content'
  ...
  BaseKpiSiteWidgetView.layout = {
    sx: 10,
    sy: 10
  };

  BaseKpiSiteWidgetView.prototype.IsUpdatingSettings = false;

  BaseKpiSiteWidgetView.prototype.IsPageLoading = true;
  ...
  BaseKpiSiteWidgetView.prototype.toggle_settings = function(e) {
    BaseKpiSiteWidgetView.__super__.toggle_settings.call(this, e);
    return this.ui.display.toggle(!this.settings_visible);
  };

  BaseKpiSiteWidgetView.prototype.set_model = function() {
    var s;
    this.IsUpdatingSettings = true;
    s = _.clone(this.model.get("settings"));
    s.site = this.ui.site.val();
  ...
  BaseKpiSiteWidgetView.prototype.onShow = function() {
    this.ui.site.on('change', (function(_this) {
      return function() {
        return _this.set_model();
      };
...
GpusummaryWidgetView = (function(superClass) {
  ...
  *********************************************************
  ...
  GpusummaryWidgetView.prototype.render_gauges = function() {
    ...
    v28id = "gauge_28volts_out_" + this.model.id;
    this.$('#view_main').append("<div id='" + vid + "'><div class='bad_data' style='display:none;'>BAD DATA</div></div>");
    return this.g3 = new JustGage({
      id: v28id,
      title: ' ',
      ...
      counter: true
    }, a28id = "gauge_28amps_out_" + this.model.id, this.$('#view_main').append("<div id='" + aid + "'><div class='bad_data' style='display:none;'>BAD DATA</div></div>"), this.g4 = new JustGage({
      id: a28id,
      title: ' ',
  ...
  GpusummaryWidgetView.prototype.data_update = function(data) {
    var aq, cls, h, icn, m, raq, rv, rvq, s, sq, stat, t, th, txt, v, vq;
    this.refresh_values();
    ...
    if (this.tagData.gpu_rdc_volts != null) {
      rvq = this.data_q(this.tagData.gpu_rdc_volts.Tag);
      this.$("#gauge_32volts_out_" + this.model.id + " .bad_data").toggle(!rvq);
      rv = this.vals.gpu_rdc_volts;
      if (rvq && !isNaN(rv) && rv !== '') {
        this.g1.refresh(parseInt(rv));
      }
    }
    if (this.tagData.gpu_rdc_amps != null) {
      raq = this.data_q(this.tagData.gpu_rdc_amps.Tag);
      this.$("#gauge_32amps_out_" + this.model.id + " .bad_data").toggle(!raq);
      rv = this.vals.gpu_rdc_amps;
      if (raq && !isNaN(rv) && rv !== '') {
    ...
    if (v > 0) {
      this.$("#gauge_amps_out_" + this.model.id).toggleClass("NoShow", false);
      this.$("#gauge_amps_out_" + this.model.id).toggleClass("NoShow", false);
      this.$("#gauge_32amps_out_" + this.model.id).toggleClass("NoShow", true);
      this.$("#gauge_32amps_out_" + this.model.id).toggleClass("NoShow", true);
    }
    if (rv > 0) {
      this.$("#gauge_amps_out_" + this.model.id).toggleClass("NoShow", true);
      this.$("#gauge_amps_out_" + this.model.id).toggleClass("NoShow", true);
      this.$("#gauge_32amps_out_" + this.model.id).toggleClass("NoShow", false);
      this.$("#gauge_32amps_out_" + this.model.id).toggleClass("NoShow", false);
    }
...
IOPSWidgetView = (function(superClass) {
  ...
  IOPSWidgetView.prototype.mark_bad_data = function(tag, el, blank) {
    var h, q;
    q = this.data_q(tag);
    h = !q ? '***' : $(el).html();
    if ((blank != null) && blank) {
  ...
  IOPSWidgetView.prototype.render_row_tzg = function(tag, tv, fv, tc, fc, format) {
    var dynamicTag, el, elName, gate, parsedTagId, tagValue, txt, v;
    dynamicTag = false;
    elName = "" + tag;
    if (/dynamic_/.test(tag)) {
      dynamicTag = true;
    ...
    tagValue = null;
    if (this.tags[tag] != null) {
      tagValue = gate + this.tags[tag];
    } else if (this.tagData[tag] != null) {
      tagValue = gate + this.tagData[tag].Tag;
    }
    return this.mark_bad_data(tagValue, el, true);
  };
  ...
  IOPSWidgetView.prototype.render_value_row_tzg = function(tag, IsNumeric, precision, format) {
    ...
    ********************************************************
     */
    var displayValue, dynamicTag, el, elName, gate, parsedTagId, set_value, tagValue;
    dynamicTag = false;
    elName = "" + tag;
    if (/dynamic_/.test(tag)) {
      dynamicTag = true;
...
PbbpcagpustatusWidgetView = (function(superClass) {
  ...
  function PbbpcagpustatusWidgetView() {
    this.set_model = bind(this.set_model, this);
    this.data_update = bind(this.data_update, this);
    return PbbpcagpustatusWidgetView.__super__.constructor.apply(this, arguments);
  }

  PbbpcagpustatusWidgetView.prototype.template = "widgets/pbb_pca_gpu_status_widget";

  PbbpcagpustatusWidgetView.prototype.classID = 'pbb_pca_gpu_status_widget';

  PbbpcagpustatusWidgetView.prototype.className = 'widget-outer box box-primary pbb_pca_gpu_status_widget';

  PbbpcagpustatusWidgetView.prototype.ui = {
    wtitle: 'h3.box-title',
    display: '.display',
    content: '.content',
    docked: 'i#docked',
  ...
  PbbpcagpustatusWidgetView.layout = {
    sx: 8,
    sy: 6
  };
  ...
  PbbpcagpustatusWidgetView.prototype.max_gates = 6;

  PbbpcagpustatusWidgetView.prototype.IsUpdatingSettings = false;
  ...
  PbbpcagpustatusWidgetView.prototype.set_model = function() {
    var s;
    this.IsUpdatingSettings = true;
    s = _.clone(this.model.get("settings"));
    s.site = this.$('#site').val();
  ...
  PbbpcagpustatusWidgetView.prototype.toggle_settings = function(e) {
    PbbpcagpustatusWidgetView.__super__.toggle_settings.call(this, e);
    this.ui.display.toggle(!this.settings_visible);
    if (this.settings_visible) {
  ...
  PbbpcagpustatusWidgetView.prototype.draw_gate_checks = function() {
    var checked, g, gate, gates, i, len, ms, prev_t, prev_z, s, settings, sh, site, t, term, terminals, z, zn;
    this.ui.gates.empty();
    site = this.$('#site').val();
    sh = '';
    s = OPCManager.get_site(site);
    if (s != null) {
      ...
      for (t in terminals) {
        ...
        for (z in term) {
          ...
          for (g in zn) {
            checked = '';
            for (i = 0, len = gates.length; i < len; i++) {
              gate = gates[i];
              if (gate === (t + ":" + z + ":" + g)) {
  ...
  PbbpcagpustatusWidgetView.prototype.onShow = function() {
    var gates, settings;
    settings = this.model.get('settings');
    settings || (settings = {});
    this.draw_selectors(settings.terminal, settings.zone, settings.gate);
  ...
  PbbpcagpustatusWidgetView.prototype.start = function() {
    return this.update();
  };

  PbbpcagpustatusWidgetView.prototype.onDestroy = function(arg1, arg2) {
    return this.kill_updates(this.site_code);
  };

  return PbbpcagpustatusWidgetView;
...
PbbsystemstatusWidgetView = (function(superClass) {
  var tagConfig, tagData;

  extend(PbbsystemstatusWidgetView, superClass);

  function PbbsystemstatusWidgetView() {
    this.set_model = bind(this.set_model, this);
    this.data_update = bind(this.data_update, this);
    return PbbsystemstatusWidgetView.__super__.constructor.apply(this, arguments);
  }

  PbbsystemstatusWidgetView.prototype.template = "widgets/pbb_system_status_widget";

  PbbsystemstatusWidgetView.prototype.classID = 'pbb_system_status_widget';

  PbbsystemstatusWidgetView.prototype.className = 'widget-outer box box-primary pbb_system_status_widget';

  PbbsystemstatusWidgetView.prototype.ui = {
    terminal: 'select#terminal',
    zone: 'select#zone',
    display_prefix: 'input#display_prefix',
    gate: 'select#gate',
  ...
  PbbsystemstatusWidgetView.layout = {
    sx: 4,
    sy: 4
  };

  PbbsystemstatusWidgetView.prototype.tags = {
    pca_mode_cooling: 'PCA.MODE_COOLING',
    pbb_autolevelfail: 'PBB.AUTOLEVEL_FAIL_FLAG',
    pbb_has_warnings: 'Warning._HasWarnings',
    pbb_has_alarms: 'Alarm._HasAlarms'
  ...
  PbbsystemstatusWidgetView.prototype.update = function() {
    var lbl, ref, ref1, s, t, tag, tags, tg;
    if (!this.IsUpdatingSettings && !this.IsPageLoading) {
      return null;
    }
  ...
  PbbsystemstatusWidgetView.prototype.data_update = function(data) {
    var aq, ref1, tag, tempSet, wq;
    this.refresh_values();
    ref1 = this.tagData;
    for (tag in ref1) {
      tagData = ref1[tag];
      switch (tagData.DataType.toLowerCase()) {
        case 'boolean':
          this.render_row("dynamic_" + tag, "", "", tagData.Parameters.Parm003, tagData.Parameters.Parm004, tagData.Parameters.Parm005);
          break;
        case 'float':
          this.render_value_row("dynamic_" + tag, tagData.Parameters.Parm001, tagData.Parameters.Parm002, tagData.Parameters.Parm003, tagData.Parameters.Parm004);
          break;
        case 'value':
          this.render_value_row("dynamic_" + tag, "", "", tagData.Parameters.Parm003, tagData.Parameters.Parm004);
          break;
        default:
          null;
      }
    ...
    tempSet = false;
    if (this.vals.pca_mode_cooling != null) {
      $("#dynamic_pca_discharge_temp").toggleClass("Cooling", this.get_bool(this.vals.pca_mode_cooling));
      tempSet = true;
    }
    if ((this.vals.pca_mode_heating != null) && !tempSet) {
      $("#dynamic_pca_discharge_temp").toggleClass("Heating", this.get_bool(this.vals.pca_mode_heating));
      tempSet = true;
    }
    aq = this.data_q(this.tags.pbb_has_alarms);
    this.ui.alarms.toggle(this.get_bool(this.vals.pbb_has_alarms) === true && aq);
  ...
  PbbsystemstatusWidgetView.prototype.toggle_settings = function(e) {
    PbbsystemstatusWidgetView.__super__.toggle_settings.call(this, e);
    return this.ui.display.toggle(!this.settings_visible);
  };

  PbbsystemstatusWidgetView.prototype.onShow = function() {
    var gate, settings;
    settings = this.model.get('settings');
    settings || (settings = {});
    this.draw_selectors(settings.terminal, settings.zone, settings.gate);
  ...
  PbbsystemstatusWidgetView.prototype.onDestroy = function(arg1, arg2) {
    return this.kill_updates(this.site_code);
  };

  return PbbsystemstatusWidgetView;
...
},{"../../common/uiutils":8,"./iops_widget_view":64}],74:[function(require,module,exports){
...
},{"./iops_widget_view":64}],75:[function(require,module,exports){
...
},{"../dashboard/widget_view":39}],77:[function(require,module,exports){
...
},{"./iops_widget_view":64}],78:[function(require,module,exports){
...
WeatherWidgetView = (function(superClass) {
  ...
  WeatherWidgetView.prototype.onShow = function() {
    ...
    this.QUARTER_HOUR = 60 * 15 * 1000;
    this.timer = setInterval(this.refresh_data, this.HOUR / 6);
